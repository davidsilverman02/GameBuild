...
#include "ShootyArena/TP_WeaponComponent.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeTP_WeaponComponent() {}
// Cross Module References
	SHOOTYARENA_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
	SHOOTYARENA_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
...
// End Cross Module References
	...
	{
		P_GET_OBJECT(AShootyArenaCharacter,Z_Param_TargetCharacter);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	struct Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon_Statics
	{
		...
		{
			AShootyArenaCharacter* TargetCharacter;
		};
	...
	template<> SHOOTYARENA_API UClass* StaticClass<UTP_WeaponComponent>()
	{
		return UTP_WeaponComponent::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UTP_WeaponComponent);
	struct Z_CompiledInDeferFile_FID_ShootyArena_Source_ShootyArena_TP_WeaponComponent_h_Statics
	{
