...
void UTP_WeaponComponent::AttachWeapon(AShootyArenaCharacter* TargetCharacter)
{
...
void UTP_WeaponComponent::ServerShoot()
{
	if(Character == nullptr || Character->GetController() == nullptr)
	{
		return;
...
void UTP_WeaponComponent::ClientShoot_Implementation()
{
	ServerShoot();
}
